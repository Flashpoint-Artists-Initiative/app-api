...
class ShiftCreateTest extends ApiRouteTestCase
{
    ...
    #[Test]
    public function shift_create_call_with_valid_data_returns_a_successful_response(): void
    {
    ...
    #[Test]
    public function shift_create_call_with_invalid_data_returns_a_validation_error(): void
    {
        $user = User::role(RolesEnum::Admin)->firstOrFail();
    ...
    #[Test]
    public function shift_create_call_without_permission_returns_error(): void
    {
    ...
    #[Test]
    public function shift_create_call_not_logged_in_returns_error(): void
    {
